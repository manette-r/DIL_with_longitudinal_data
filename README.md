...
```cl_step``` indicates which version of continual learning to load, and ```csv_file_data_memory``` specifies the generic file name, excluding the cl_step and csv extensions.
